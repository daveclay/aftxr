...
class Glitch {
    constructor(element, imgSrc) {
        ...
        this.consoleSignature = new ConsoleSignature();
    }
...
//
    resizeWindow() {
        ...
        this.cameraBack.aspect = window.innerWidth / window.innerHeight;
        this.cameraBack.updateProjectionMatrix();
        this.bgImg.resize();
        this.postEffect.resize();
        this.renderBack1.setSize(window.innerWidth, window.innerHeight);
